 ...
 // const { login, loading } = useAuth();
  ...
  const handleGoogleLogin = () => {
    window.location.href =
      "https://stock-trading-platform-6x0l.onrender.com/api/auth/google";
  };
        ...
        <div className="">
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-sm text-center">
              Sign in to your StockTread account
            </p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full border border-gray-300 rounded-xl px-12 py-3 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
              />
              <button
                type="button"
