...
function Footer() {
    return (
        <footer  style={{backgroundColor:"rgb(250,250,240)"}}>
        <div className="container border mt-4 ">
            <div className="row "> 
                <div className="col"> <img src="media/images/logo.svg" alt="Zerodha Logo" style={{width:"60%" }} />
                
                 <p>© 2026 Zerodha Broking Limited. All rights reserved.</p>
                </div>
                      
                        <div className="col"> Company <b/><br/>
                         <a href=""> About</a><br/>
                        ...
                        <a href=""> 
                                   Status of your complaints</a><br/>
